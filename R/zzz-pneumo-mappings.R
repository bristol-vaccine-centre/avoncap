...
map_avoncap_pneumococcal = function() list(
  ...
  # "pcv13_serotype",
  # "pcr_sample",
  "smoker" = .normalise_list(demog.smoker, c("Non-smoker", "Ex-smoker", "Current smoker")),
  ...
  "ppv23" = .normalise_list(vaccination.ppv, c("No", "Under 6 months", "Over 6 months")),
  "flu_vaccine" = .normalise_list(vaccination.flu, c("No", "Under 6 months", "Over 6 months")),
  # "cci_age_score",
  # "mi_score",
  # "chf_score",
  # "pvd_score",
  ...
  "aki" = .normalise_yesno(outcome.akute_kidney_injury),
